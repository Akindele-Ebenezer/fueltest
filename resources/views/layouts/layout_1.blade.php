            ...
            <center><img src="/images/depasa-logo.png"></center> <br>
                <ul>
                    ...
                    <div class="sub-section-show">
                        <ul>
                            <li>Overall Supply<span>24</span></li>
                            <li>Failed Results <span>24</span></li>
                            <li>Passed Tests <span>24</span></li>
                            <li>Waived <span>24</span></li>
                            <li>Vendors with Supply Status <span>24</span></li>
                        </ul>
                    </div> 
                    ...
                    <section class='sub-section-container'>
                        ...
                        <div class="sub-section">
                            <ul>
                                <li>Approved (Passed) <span>24</span></li>
                                <li>Waived (Overlooked) <span>24</span></li>
                                <li>Rejected (Failed) <span>24</span></li>
                            </ul>
                            <h2>RECENT</h2>
                            <ul>
                                <li>Last month's supply<span>24</span></li>
                                <li>Fuel supplied this month<span>24</span></li>
                                <li>Supplies One week ago<span>24</span></li>
                            </ul>
                        </div>
                    </section>
                    <section class='sub-section-container'>
                        ...
                        <div class="sub-section">
                            <ul>
                                @foreach ($vendors as $Vendor)
                                    <li>{{ $Vendor->VendorName }} <span class="vendor-no">{{ $Vendor->VendorNo }}</span> </li> 
                                @endforeach
                            </ul>
                        </div> 
                    </section>
                    ...
                    <div class="sub-section-show">
                        <ul>
                            <li>Online <span>24</span></li>
                            <li>Offline <span>24</span></li> 
                            <li>Admin <span>24</span></li> 
                            <li>User <span>24</span></li> 
                        </ul>
                    </div> 
