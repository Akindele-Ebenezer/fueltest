...
@if(Route::is('previous_records'))
    ...
    [{{ $previous_record->ApprovalForUse === 'APPROVED' ? 'Test for this record created on ' . $previous_record->SampleCollectionDate . ', ' . Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $previous_record->created_at)->format('H:i A') . ' is Passed' : '' }}{{ $previous_record->ApprovalForUse === 'REJECTED' ? 'Test for this record created on ' . $previous_record->SampleCollectionDate . ', ' . Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $previous_record->created_at)->format('H:i A') . ' is Rejected' : '' }}{{ $previous_record->ApprovalForUse === 'WAIVED' ? 'Test for this record created on ' . $previous_record->SampleCollectionDate . ', ' . Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $previous_record->created_at)->format('H:i A') . ' is Waived' : '' }}] <br> 

    @elseif(Route::is('all_records'))

    [{{ $record->ApprovalForUse === 'APPROVED' ? 'Test for this record created on ' . $record->SampleCollectionDate . ', ' . Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $record->created_at)->format('H:i A') . ' is Passed' : '' }}{{ $record->ApprovalForUse === 'REJECTED' ? 'Test for this record created on ' . $record->SampleCollectionDate . ', ' . Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $record->created_at)->format('H:i A') . ' is Rejected' : '' }}{{ $record->ApprovalForUse === 'WAIVED' ? 'Test for this record created on ' . $record->SampleCollectionDate . ', ' . Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $record->created_at)->format('H:i A') . ' is Waived' : '' }}] <br> 
