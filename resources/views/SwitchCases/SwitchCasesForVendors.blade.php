@php
    ...
    for ($i=0; $i < 1; $i++) {   
        ...
        ${"ApprovedTestsFor" . str_replace(' ', '', Route::is('all_records') ? $record->VendorName : (Route::is('previous_records') ? $previous_record->VendorName : $Vendor->VendorName))}   = App\Models\FuelTestRecord::select('id')->where('VendorName', Route::is('all_records') ? $record->VendorName : (Route::is('previous_records') ? $previous_record->VendorName : $Vendor->VendorName))
                                                                                                                                                                                                                        ->where('ApprovalForUse', 'APPROVED')
                                                                                                                                                                                                                        ->orderBy('VendorName')
                                                                                                                                                                                                                        ->get()
                                                                                                                                                                                                                        ->count();

        ${"RejectedTestsFor" . str_replace(' ', '', Route::is('all_records') ? $record->VendorName : (Route::is('previous_records') ? $previous_record->VendorName : $Vendor->VendorName))}  = App\Models\FuelTestRecord::select('id')->where('VendorName', Route::is('all_records') ? $record->VendorName : (Route::is('previous_records') ? $previous_record->VendorName : $Vendor->VendorName))
                                                                                                                                                                                                                        ->where('ApprovalForUse', 'REJECTED')
                                                                                                                                                                                                                        ->orderBy('VendorName')
                                                                                                                                                                                                                        ->get()
                                                                                                                                                                                                                        ->count();

        ${"WavedTestsFor" . str_replace(' ', '', Route::is('all_records') ? $record->VendorName : (Route::is('previous_records') ? $previous_record->VendorName : $Vendor->VendorName))}  = App\Models\FuelTestRecord::select('id')->where('VendorName', Route::is('all_records') ? $record->VendorName : (Route::is('previous_records') ? $previous_record->VendorName : $Vendor->VendorName))
