        ...
        <section class="show-record ">
            <section class="show-record-side-bar fuel-test-main"> 
                ...
                <center>{{ $MyRecord->VendorNo }}</center>
                 <br>
                <h2 class="">MADE BY:</h2>
                <span>{{ $MyRecord->MadeBy }}</span> 
                <br><br>
                <div class="record-info">
                    <p>You are editing the RECORD with the SAMPLE NO. {{ $MyRecord->SampleNo }}. 
                ...
                <div class="form">
                    <form action="/UpdateMyRecord/{{ $MyRecordId }}">
                        <div class="edit-vendor-details">  
                            ...
                            <input class="select" type="text" placeholder="Vendor No..." name="VendorNo" value="{{ $MyRecord->VendorNo }}" autocomplete="off">
                            ...
                            <input type="text" placeholder="Name of VENDOR..." name="VendorName" value="{{ $MyRecord->VendorName }}"> 
                        </div> 
                        <div>
                            ...
                            <input name="SampleNo" type="text" value="{{ $MyRecord->SampleNo }}">
                        </div>
                        <div>
                            ...
                            <input name="SampleCollectionDate" type="date" value="{{ $MyRecord->SampleCollectionDate }}">
                        </div>
                        <div>
                            ...
                            <input name="TruckPlateNo" type="text" placeholder="Enter Plate No." value="{{ $MyRecord->TruckPlateNo }}">
                        </div>
                        <div>
                            ...
                            <input name="TankNo" type="text" placeholder="Input Plate No." value="{{ $MyRecord->TankNo }}">
                        </div>
                        <div>
                            ...
                            <input type="text" class="appearance-result select" value="{{ $MyRecord->AppearanceResult }}" name="AppearanceResult" readonly>                 
                        ...
                        <div>
                            ...
                            <input type="text" class="choose-color select" value="{{ $MyRecord->Color }}" name="Color" readonly>                 
                        ...
                        <div>
                            ...
                            <input name="Density" type="text" placeholder="Input Density..." value="{{ $MyRecord->Density }}">
                        </div>
                        <div>
                            ...
                            <input name="FlashPoint" type="text" placeholder="Enter Flash Point..." value="{{ $MyRecord->FlashPoint }}">
                        </div>
                        <div>
                            ...
                            <input name="Temp" type="text" placeholder="Temperature..." value="{{ $MyRecord->Temp }}">
                        </div>
                        <div>
                            ...
                            <input name="WaterSediment" type="text" placeholder="Required..." value="{{ $MyRecord->WaterSediment }}">
                        </div>
                        <div>
                            ...
                            <input name="Cleanliness" type="text" placeholder="Cleanliness..." value="{{ $MyRecord->Cleanliness }}">
                        </div>
                        <div>
                            ...
                            <input name="DateOfTest" type="date" value="{{ $MyRecord->DateOfTest }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" class="made-by select" value="{{ $MyRecord->MadeBy }}" name="MadeBy" readonly>                 
                        ...
                        <div>
                            ...
                            <input name="DeliveredTo" type="text" placeholder="Delivered To..." value="{{ $MyRecord->DeliveredTo }}">
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M96.2 200.1C96.07 197.4 96 194.7 96 192C96 103.6 167.6 32 256 32C315.3 32 367 64.25 394.7 112.2C409.9 101.1 428.3 96 448 96C501 96 544 138.1 544 192C544 204.2 541.7 215.8 537.6 226.6C596 238.4 640 290.1 640 352C640 422.7 582.7 480 512 480H144C64.47 480 0 415.5 0 336C0 273.2 40.17 219.8 96.2 200.1z"/></svg>                     
                            <label for="ApprovalForUse">Approval For Use</label><br>  
                            <input type="text" class="approval-for-use select" value="{{ $MyRecord->ApprovalForUse }}" name="ApprovalForUse" readonly>                 
                        ...
                        <div>
                            ...
                            <input name="Remarks" type="text" placeholder="Remarks..." value="{{ $MyRecord->Remarks }}">
                        </div>
                        <div>
                    ...
                    <td class="pdf-and-edit">
                        ...
                        <form action="" > 
                            ...
                            <label>
                                ...
                                <input type="hidden" name="EditMyRecord_SAMPLE_NO" value="{{ $previous_record->SampleNo }}">
                                <input type="submit" class="hide" name="EditMyRecord">
                            </label>
                        </form> 
