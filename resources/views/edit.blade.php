        ...
        <div class="form">
            <form action="/Edit/{{ $SampleNo }}">
                <div>  
                    ...
                    <input type="text" placeholder="Vendor No..." name="VendorNo" value="{{ $VendorNo }}"><input type="text" id="EditVendorName" placeholder="Name of VENDOR..." name="VendorName" value="{{ $VendorName }}">                    
                </div> 
                <div>
