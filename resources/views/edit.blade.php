...
@section('content')
    <div class="fuel-test-main">
        ...
        <div class="form">
            <form action="/edit/{{ $SampleNo }}" method="post">@csrf
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="AppearanceResult" value="{{ $AppearanceResult }}"> 
                </div>
                <div>
                ...
                <div>
                    <center><button type="submit">UPDATE RECORD</button></center>
                </div>
            </form>
        </div>
    </div>
