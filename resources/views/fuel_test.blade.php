...
@section('content') 
    <div class="fuel-test-main">
        <h1>FUEL TEST</h1>  
        <div class="form"> 
            <form action="{{ route('record_success') }}" method="post">@csrf
                ...
                <div>
                    ...
                    <input type="text" value="{{ $sample_no . '0' . $number_of_previous_records }}" name="SampleNo">
                </div>
                <div>
                    ...
                    <input type="date" name="SampleCollectionDate">
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Vendor No..." name="VendorNo"><input type="text" placeholder="Vendor Name..." name="VendorName">
                        <!-- <section class="filter">
                            <ul>
                                <form action="" method="get" class="vendors">
                                    <center>
                                        <p>VENDORS</p>
                                    </center>
                                    @foreach($vendors as $vendor)
                                        <li>
                                            <input type="checkbox" name="Vendors[]" value="{{ $vendor->VendorName }}"> {{ $vendor->VendorName }}
                                        </li>   
                                    @endforeach
                                </form>
                            </ul>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Enter Plate No." name="TruckPlateNo">
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Input Tank No." name="TankNo">
                </div>
                <div>
                    ...
                    <select name="AppearanceResult">
                        <option value="Select Appearance" >Select Appearance</option>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Input Density..." name="Density">
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Enter Flash Point..." name="FlashPoint">
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Temperature..." name="Temp">
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Required..." name="WaterSediment">
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Cleanliness..." name="Cleanliness">
                </div>
                <div>
                    ...
                    <input type="date" name="DateOfTest">
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M448 416C448 451.3 419.3 480 384 480H64C28.65 480 0 451.3 0 416V96C0 60.65 28.65 32 64 32H384C419.3 32 448 60.65 448 96V416zM256 160C256 142.3 241.7 128 224 128H128C110.3 128 96 142.3 96 160C96 177.7 110.3 192 128 192H224C241.7 192 256 177.7 256 160zM128 224C110.3 224 96 238.3 96 256C96 273.7 110.3 288 128 288H320C337.7 288 352 273.7 352 256C352 238.3 337.7 224 320 224H128zM192 352C192 334.3 177.7 320 160 320H128C110.3 320 96 334.3 96 352C96 369.7 110.3 384 128 384H160C177.7 384 192 369.7 192 352z"/></svg>
                    <label for="TestResult">Test Result</label><br>
                    <select name="TestResult">
                        <option value="Select Test Result" >Select Test Result</option>
                        <option value="Bright">FAIL</option>
                        <option value="Clear">PASS</option>
                        <option value="Muddy">PARCIAL</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input list="MadeBy" name="MadeBy">
                    <datalist id="MadeBy"> 
                        @foreach($fuel_test_users as $fuel_test_user)
                            <option value="{{ $fuel_test_user->Name }}">  
                        @endforeach
                    </datalist>
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Delivered To..." name="DeliveredTo">
                </div>
                <div>
                ...
                <div>
                    <center><button type="submit" name="submit">Create Record</button></center>
                </div>
            </form>
        </div>
    </div>
