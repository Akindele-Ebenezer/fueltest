        ...
        <div class="form"> 
            <form action="{{ route('record_success') }}">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $sample_no . '0' . $number_of_previous_records }}" name="SampleNo" readonly>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" class="appearance-result select" placeholder="Appearance Result..." name="AppearanceResult" readonly>                 
                ...
                <div>
                    ...
                    <input type="text" class="choose-color select" placeholder="Choose Color..." name="Color" readonly>                 
                ...
                <div>
                    ...
                    <input type="text" class="made-by select" placeholder="Made By..." name="MadeBy" readonly>                 
                ...
                <div>
                    ...
                    <input type="text" class="approval-for-use select" placeholder="Choose Approval..." name="ApprovalForUse" readonly>                 
