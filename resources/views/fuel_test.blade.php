        ...
        <div class="form"> 
            <form action="{{ route('record_success') }}">
                ...
                <div>
                    ...
                    <input type="text" value="{{ isset($_GET['GetRecord']) ? $SampleNo : $sample_no . $number_of_all_records_absolute }}" name="SampleNo" readonly>
                </div>
                <div>
                ...
                <div>  
                    ...
                    <input class="select" type="text" placeholder="Vendor No..." name="VendorNo" value="{{ isset($_GET['GetRecord']) ? $VendorNo : $VendorNo }}" autocomplete="off">
