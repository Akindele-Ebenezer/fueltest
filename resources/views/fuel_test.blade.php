        ...
        <div class="form"> 
            <form action="{{ route('record_success') }}">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $sample_no . $number_of_all_records_absolute }}" name="SampleNo" readonly>
                </div>
                <div>
                    ...
                    <input type="date" name="SampleCollectionDate" value="{{ old('SampleCollectionDate') }}"> 
                    <p>{{ $SampleCollectionDateErrorMessage }}</p> 
                </div>
                <div>  
                ...
                <div>
                    ...
                    <input type="text" placeholder="Enter Plate No." name="TruckPlateNo" value="{{ old('TruckPlateNo') }}">
                    <p>{{ $TruckPlateNoErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Input Tank No." name="TankNo" value="{{ old('TankNo') }}">
                    <p>{{ $TankNoErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <p>{{ $AppearanceResultErrorMessage }}</p>  
                    <input type="text" class="appearance-result select" placeholder="Appearance Result..." name="AppearanceResult" value="{{ old('AppearanceResult') }}" readonly>                 
                ...
                <div>
                    ...
                    <p>{{ $ColorErrorMessage }}</p>  
                    <input type="text" class="choose-color select" placeholder="Choose Color..." name="Color" value="{{ old('Color') }}" readonly>                 
                ...
                <div>
                    ...
                    <input type="text" placeholder="Input Density..." name="Density" value="{{ old('Density') }}">
                    <p>{{ $DensityErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Enter Flash Point..." name="FlashPoint" value="{{ old('FlashPoint') }}">
                    <p>{{ $FlashPointErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Temperature..." name="Temp" value="{{ old('Temp') }}">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Required..." name="WaterSediment" value="{{ old('WaterSediment') }}">
                    <p>{{ $WaterSedimentErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Cleanliness..." name="Cleanliness" value="{{ old('Cleanliness') }}">
                    <p>{{ $CleanlinessErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <input type="date" name="DateOfTest" value="{{ old('DateOfTest') }}">
                    <p>{{ $DateOfTestErrorMessage }}</p> 
                </div> 
                ...
                <div>
                    ...
                    <p>{{ $MadeByErrorMessage }}</p>
                    <input type="text" class="made-by select" placeholder="Made By..." name="MadeBy" value="{{ old('MadeBy') }}" readonly>                 
                ...
                <div>
                    ...
                    <p>{{ $ApprovalForUseErrorMessage }}</p>  
                    <input type="text" class="approval-for-use select" placeholder="Choose Approval..." name="ApprovalForUse" value="{{ old('ApprovalForUse') }}" readonly>                 
                ...
                <div>
                    ...
                    <input type="text" placeholder="Delivered To..." name="DeliveredTo" value="{{ old('DeliveredTo') }}">
                    <p>{{ $DeliveredToErrorMessage }}</p> 
                </div>
                <div>
                    ...
                    <input type="text" placeholder="Remarks..." name="Remarks" value="{{ old('Remarks') }}">
