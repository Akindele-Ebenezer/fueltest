        ...
        <div class="form">
            <form action="/update/{{ $SampleNo }}" method="post">@csrf
                ...
                <div>
                    ...
                    <select name="AppearanceResult" value="{{ $AppearanceResult }}">
                        <option value="Select Appearance" >{{ $AppearanceResult }}</option>
                ...
                <div>
                    ...
                    <input name="MadeBy" list="MadeBy" name="MadeBy" value="{{ $MadeBy }}">
                    <datalist id="MadeBy"> 
                        <option value="Akindele Ebenezer">    
                        <option value="New User">
                        <option value="Ebenezer Akindele ">
                    </datalist>
                </div>
                <div>
