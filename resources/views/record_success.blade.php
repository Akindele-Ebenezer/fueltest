...
@section('content')
    <div class="fuel-test-main">
        ...
        <div class="form">
            <form action="/update/{{ $SampleNo }}" method="post">@csrf
                <div>  
                    ...
                    <input type="text" placeholder="Vendor No..." name="VendorNo" list="Vendors" value="{{ $VendorNo_ }}"><input type="text" placeholder="Name of VENDOR..." name="VendorName" value="{{ $VendorName_ }}">
                    <datalist id="Vendors">
                ...
                <div>
                    ...
                    <input type="text" class="appearance-result select" placeholder="Appearance Result..." name="AppearanceResult" value="{{ $AppearanceResult }}" readonly>                 
                ...
                <div>
                    ...
                    <input type="text" class="choose-color select" placeholder="Choose Color..." name="Color" value="{{ $Color }}" readonly>                 
                ...
                <div>
                    ...
                    <input name="DateOfTest" type="text" placeholder="Date..." value="{{ $DateOfTest }}">
                </div>
                <input name="uid" type="hidden" value="{{ $id }}">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256c70.7 0 128-57.31 128-128s-57.3-128-128-128C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3c0 19.14 15.52 34.67 34.66 34.67h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304z"/></svg>
                    <label for="MadeBy">Made By (Name)</label><br>
                    <input type="text" class="made-by select" placeholder="Made By..." name="MadeBy" value="{{ $MadeBy }}" readonly>                 
